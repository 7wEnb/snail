define(['jcookie'], function() {
    return {
        init: function() {
            ...
            const $smallpic = $('.small_picture');
            const $bpic = $('.big_picture');
            const $title = $('.title');
            ...
            //2.将sid传给后端
            $.ajax({
                url: 'http://192.168.13.28/projectname/php/getsid.php',
                data: {
                    sid: $sid
                },
                dataType: 'json'
                ...
                $.each(picarr, function(index, value) {
                    $strhtml += '<li><a href="JavaScript:;" class="cur"><img src="' + value + '"/>></a></li>';
                });
                $('.tablist ul').html($strhtml);
            });
